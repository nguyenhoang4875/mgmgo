...
public class Image extends TableImpl<ImageRecord> {
    ...
    private static final long serialVersionUID = -825331819;
     ...
     */
    public final TableField<ImageRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('image_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
